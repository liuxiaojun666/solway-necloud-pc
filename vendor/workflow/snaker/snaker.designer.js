(function(snaker){
    ...
    designer.util = {
        ...
        tip : function(rect, name) {
            ...
            console.info(document.getElementById('snakerflow').offsetLeft+rect.attr('x'), document.getElementById('snakerflow').offsetTop+rect.attr('y')+52)
            $.ajax({
                type:'GET',
                url:designer.config.ctxPath+"/snaker/task/tip.htm",
