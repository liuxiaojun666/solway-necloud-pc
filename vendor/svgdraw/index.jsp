...
<!{else}-->
  ...
  <script type="text/javascript" src="extensions/ext-svg.js"></script>
  <script type="text/javascript" src="lib/requestanimationframe.js"></script>
  <script type="text/javascript" src="lib/taphold.js"></script>
  <script type="text/javascript" src="lib/filesaver.js"></script>
  <script type="text/javascript" src="src/customs.js"></script>
<!--{endif}-->
<style>
  .tool_button.svg_button {
    width: 80px;
    height: 80px;;
  }
</style>
...
<div id="menu_bar">
  <div id="info_bar">
    ...
    <div class="info_bar_box">
      <div class="title">选择电站</div>
      <div class="st_select_box">
        <div class="st_select">
          <div class="st_content" data-stid="">选择电站</div>
          <div class="st_area"></div>
        </div>
        <ul class="st_sel">
        </ul>
      </div>
    ...
    <div class="info_bar_box">
      <div class="name_text">
        <input type="checkbox" name="isDisplay" class="isDisplay"/>
        <span class="isDisplay">默认显示</span>
      </div>
    </div>
    <div class="info_bar_box">
      <button id="tool_save" style="padding: 3px 17px;font-size: 12px;cursor: pointer;">导出</button>
      <button class="save_button" style="padding: 3px 17px;font-size: 12px;cursor: pointer;">保存</button>
      <button class="cancel_button" style="padding: 3px 17px;font-size: 12px;cursor: pointer;">返回</button>
    </div>
  </div>
  <%--<a class="menu">--%>
    ...
    <%--<div class="menu_list">--%>
      ...
      <%--<div id="tool_abouts" class="menu_item">Keyboard Shortcuts...</div>--%>
    <%--</div>--%>
  <%--</a>--%>
  <%----%>
  <%--<div class="menu">--%>
    ...
    <%--<div class="menu_list" id="file_menu"> --%>
      ...
      <%--<div id="tool_saveData" class="menu_item">Save...</div>--%>
  ...
  <%--<div class="menu">--%>
    <%--<div style="color: #fff;position: relative;top: 7px;">选择电站：</div>--%>
  <%--</div>--%>
  <%--<div class="menu">--%>
    <%--<p style="height: 18px;width: 120px;border:1px solid #fff;margin: 0px;position: absolute;top: 0px;"></p>--%>
  <%--</div>--%>
</div>

<div id="tools_top" class="tools_panel">
  <div id="windTurbine_panel" class="context_panel clearfix">
    <h4 class="clearfix">风电机组</h4>
    <div class="title">所属风电机组：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="windTurbine">选择风电机组</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  </div>

  <div id="windTower_panel" class="context_panel clearfix">
    <h4 class="clearfix">测风塔</h4>
    <div class="title">所属测风塔：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="windTower">选择测风塔</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="HLX_panel" class="context_panel clearfix">
    <h4 class="clearfix">汇流箱</h4>
    <div class="title">所属汇流箱：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="HLX">选择汇流箱</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="NBQ_panel" class="context_panel clearfix">
    <h4 class="clearfix">逆变器</h4>
    <div class="title">所属逆变器：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="NBQ">选择逆变器</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
...
<%--
  --%>
  <div id="NBQHLX_panel" class="context_panel clearfix">
    <h4 class="clearfix">逆变器&汇流器</h4>
    <div class="title">所属逆变器&汇流器：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="NBQHLX">选择逆变器&汇流器</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="XB_panel" class="context_panel clearfix">
    <h4 class="clearfix">箱变</h4>
    <div class="title">所属箱变：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="XB">选择箱变</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="videoImage_panel" class="context_panel clearfix">
    <h4 class="clearfix">视频监控点</h4>
    <div class="title">所属视频监控点：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="videoImage">选择视频监控点</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="Meter_panel" class="context_panel clearfix">
    <h4 class="clearfix">电表监控点</h4>
    <div class="title">所属电表监控点：</div>
    <div class="select_box">
      <div class="select_input_box">
        <div class="select_input_content" type="Meter">选择电表监控点</div>
        <div class="select_input_area"></div>
      </div>
      <ul class="select_sel"></ul>
    </div>
  ...
  <div id="canvas_panel" class="context_panel">
    ...
    <label data-title="Change canvas backgroudImage" class="draginput">
      <span>BgImage</span>
      <div id="bgImage_canvas_tools">
        <div class="bgImage_box">
          <div class="bgImage_upload">
            <p>上传</p>
            <%--<input type="file" id="fileBgImage" accept="image/png"/>--%>
            <input type="file" id="fileBgImage" accept="image/png,image/jpg,image/jpeg,image/bmp"/>
          </div>
          <div class="bgImage_image">
            <!--<img src="" width="60" height="40" class="smallImage"/>-->
            <!--<div class="delp"><a href="javascript:;">删除</a></div>-->
          </div>
        </div>
      </div>
    </label>
...
<script id="stidListTmpl" type="text/x-jquery-tmpl">
  {{each(i,d) data}}
    <li data-stid="{{= d.id}}">{{= d.stationname}}</li>
  {{/each}}
</script>
<script id="deviceListTmpl" type="text/x-jquery-tmpl">
  {{each(i,d) data}}
    <li data-id="{{= d.serialNumber}}">{{= d.name}}</li>
  {{/each}}
</script>
</body>
</html>
