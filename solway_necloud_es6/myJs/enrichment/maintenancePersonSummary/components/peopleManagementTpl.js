ajaxData({
    ...
    $scope.trClick = (item, index, event) => {
        ...
        if (event.target.className.includes('realname')){
            ...
            $scope.$broadcast('userId',item.id);
        };
