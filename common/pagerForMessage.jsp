<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	<div class="col-sm-12 no-padder" style="min-width: 280px;">
	<ul class="pull-right pagination pagination-sm no-padder m-n bg-white2 "
		...
		<li>
			<input class="form-control pull-left text-center" ng-model="goPageNum"
			style="width: 30px;height: 28px;padding: 0 5px;display: inline-block;" type="text" onKeyUp="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" >
		...
		<span class=" pull-right ">
	 	<!-- <small style="float: left;margin-top:8px;" class="text-muted m-l-xs m-r-xs font-h6">&nbsp;</small>
             <select id="pageSizeSelect" style="float: left;width:80px;height:30px;" class="form-control" ng-model="pageSizeSelect" ng-change="onSelectPage(1)">
