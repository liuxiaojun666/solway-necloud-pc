	...
	<head>
		...
		<script type="text/javascript">
			...
			function saveModel(data) {
				...
				$.ajax({
					type:'POST',
					url:"${ctx}/snaker/process/deployXml.htm",
					...
					success: function(data){
						if(data == true) {
							window.location.href = "${ctx}/snaker/process/list.htm";
						} else {
							alert('数据处理错误！');
						}
					}
...
<div id="toolbox">
	...
	<div class="node" id="save">
		<img src="${ctx}/vendor/workflow/snaker/images/save.gif"/>&nbsp;&nbsp;保存
	</div>
	<div>
		<hr/>
	</div>
	<div class="node selectable" id="pointer">
		<img src="${ctx}/vendor/workflow/snaker/images/select16.gif"/>&nbsp;&nbsp;Select
	</div>
	<div class="node selectable" id="path">
		<img src="${ctx}/vendor/workflow/snaker/images/16/flow_sequence.png"/>&nbsp;&nbsp;transition
	</div>
<div>
<hr/>
</div>
	<div class="node state" id="start" type="start">
		<img src="${ctx}/vendor/workflow/snaker/images/16/start_event_empty.png"/>&nbsp;&nbsp;start
	</div>
	<div class="node state" id="end" type="end">
		<img src="${ctx}/vendor/workflow/snaker/images/16/end_event_terminate.png"/>&nbsp;&nbsp;end
	</div>
	<div class="node state" id="task" type="task">
		<img src="${ctx}/vendor/workflow/snaker/images/16/task_empty.png"/>&nbsp;&nbsp;task
	</div>
	<div class="node state" id="task" type="custom">
		<img src="${ctx}/vendor/workflow/snaker/images/16/task_empty.png"/>&nbsp;&nbsp;custom
	</div>
	<div class="node state" id="task" type="subprocess">
		<img src="${ctx}/vendor/workflow/snaker/images/16/task_empty.png"/>&nbsp;&nbsp;subprocess
	</div>
	<div class="node state" id="fork" type="decision">
		<img src="${ctx}/vendor/workflow/snaker/images/16/gateway_exclusive.png"/>&nbsp;&nbsp;decision
	</div>
	<div class="node state" id="fork" type="fork">
		<img src="${ctx}/vendor/workflow/snaker/images/16/gateway_parallel.png"/>&nbsp;&nbsp;fork
	</div>
	<div class="node state" id="join" type="join">
		<img src="${ctx}/vendor/workflow/snaker/images/16/gateway_parallel.png"/>&nbsp;&nbsp;join
	</div>
</div>
