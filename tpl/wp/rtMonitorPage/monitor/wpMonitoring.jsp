...
<div ng-controller="wpMonitoringCtrl">
                            ...
                            <div class="col-xs-12 b-r-black panel-heading panel-green cp" style="padding: 15px 5px 8px;height: 140px;" ng-click="showRealPower('1')">
                                <div class="stat">
                                    ...
                                    <div class="col-xs-12 no-padder m-t-mmd " ng-show="posJcvFlag">
                                        ...
                                        <div class="col-xs-6 no-padder" ng-show="posJcvFlag">
                                            <div class="m-t-n-xs">
                                                <div class="stat-label">风速</div>
                                                <h4 class="m-n">
                                                    <span ng-bind="statDayData.windSpeed|dataNullFilter">-</span>
                                                    <span >m/s</span>
                                                </h4>
                                            </div>
                                        </div>
...
<script src="${ctx}/theme/js/wp/wpMonitoring.js"type="text/javascript"></script>
...
<script>
    ...
    function responseHeight(){
        ...
        //$("#ssglqx").css("height", $(window).height() - 380);
    }
