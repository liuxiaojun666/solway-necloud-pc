<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- 综合评估 -->
	<style>
	#radarMapLeft2 >div{width:100%;}
	#radarMapRight2 >div{width:100%;}
	</style>
<div class="col-sm-12 wrapper first-right " ng-controller="mpRadarYearCtrl">
	<div class="col-sm-6">
		<div id="radarMapLeft2"  style="height:300px;width:400px;"></div>
	</div>
	<div class="col-sm-6">
		<div id="radarMapRight2" style="height:300px;width:400px;"></div>
	</div>
</div>
<script>

app.controller('mpRadarYearCtrl',function($scope, $http, $state, $stateParams) {
	
	var dataType;
    $scope.$on("toPageRadarYear",function(e,data){
    	dataType = data;
    	dayDataDown();
    });
    
    var myChartDirection = echarts.init(document.getElementById('radarMapLeft2'));
	window.addEventListener("resize", function() {
		myChartDirection.resize();
	});
	
	var myChartSpeed = echarts.init(document.getElementById('radarMapRight2'));
	window.addEventListener("resize", function() {
		myChartSpeed.resize();
	});
