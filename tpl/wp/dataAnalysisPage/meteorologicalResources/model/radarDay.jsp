<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- 综合评估 -->
	<style>
	#radarMapLeft1 >div{width:100%;}
	#radarMapRight1 >div{width:100%;}
	</style>
<div class="col-sm-12 wrapper first-right " ng-controller="mpRadarDayCtrl">
	<div class="col-sm-6">
		<div id="radarMapLeft1"  style="height:300px;width:400px;"></div>
	</div>
	<div class="col-sm-6">
		<div id="radarMapRight1" style="height:300px;width:400px;"></div>
	</div>
</div>
<script>

app.controller('mpRadarDayCtrl',function($scope, $http, $state, $stateParams) {
	
	var dataType;
    $scope.$on("toPageRadarDay",function(e,data){
    	dataType = data;
    	dayDataDown();
    });
    
    var myChartDirection = echarts.init(document.getElementById('radarMapLeft1'));
	window.addEventListener("resize", function() {
		myChartDirection.resize();
	});
	
	var myChartSpeed = echarts.init(document.getElementById('radarMapRight1'));
	window.addEventListener("resize", function() {
		myChartSpeed.resize();
	});
