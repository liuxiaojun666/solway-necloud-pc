...
.modal-open {
 ...
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="wpRankingCtrl">
	...
	<div ng-include="'${ctx}/tpl/wp/dataAnalysisPage/wpRanking/modelContainer.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('wpRankingCtrl',function($scope, $http, $state, $stateParams) {
	$scope.showDay = false;
