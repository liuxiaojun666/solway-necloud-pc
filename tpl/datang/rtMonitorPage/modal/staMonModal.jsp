<%@ page language="java" contentType="text/html; charset=UTF-8"
		 pageEncoding="UTF-8"%>
<div class="col-sm-12 no-padder" ng-controller="dtStaMonCtrl">
...
<script>
	var myChart;
	app.controller('dtStaMonCtrl',function($scope, $http, $state,$rootScope) {
		//得到当前月时间
