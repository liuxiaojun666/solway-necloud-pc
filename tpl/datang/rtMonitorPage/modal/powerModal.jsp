...
<div class="modal fade noteModal" id="powerIndexModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog row" style="width:85%;">
		<div class="modal-content col-sm-12 no-padder">
			<a class="icon-close modelCloseBtn time black-1" style="color:white;" ng-click="hiddenModal()"></a>
			<div id="text" style="overflow-y: auto; overflow-x: hidden;">
