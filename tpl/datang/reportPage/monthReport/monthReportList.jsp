...
<div ng-controller="dtMonthReportListCtrl">
    ...
    <div class="page-padding word-black">
        ...
        <div class="clearfix">
            ...
            <div class="fill-page-con" ng-show="listOrFill == 'fillPage'">
                 <div data-ng-include="'${ctx}/tpl/datang/reportPage/monthReport/monthReportChangePage.jsp'"></div>
            </div>
        </div>
    </div>
</div>
...
app.controller('dtMonthReportListCtrl', function($scope,$rootScope,$http, $state, $stateParams,$interval) {
    ...
    $scope.showFillPage = function(item){
        $scope.listOrFill = "fillPage";
        $scope.$broadcast("fillItem",[item,"month"]);
    }
	...
	$scope.deleteBatch = function(){
        ...
        if (conti) {
            ...
            $http({
                method : "POST",
                url : "${ctx}/rpmSummary/deleteBatch.htm",
                params : {
                    'ids' :checkedIds,
                }
            }).success(function(result) {
