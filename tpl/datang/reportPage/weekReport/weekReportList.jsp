...
<div ng-controller="dtWeekReportListCtrl">
    ...
    <div class="page-padding word-black">
        ...
        <div class="clearfix">
                    ...
                    <table id="result_table" class="table table-striped b-t b-light">
                        ...
                        <tbody class="font12">
                            <tr ng-repeat="vo in data">
                                ...
                                <td class="text-left" ng-bind="vo.stationName"></td>
                                <td class="text-center" ng-bind="vo.busiDate |date:'yyyy-MM'"></td>
                                <td class="text-left" ng-bind="vo.createUserName"></td>
                                <td class="text-center" ng-bind="vo.createDate |date:'yyyy-MM'"></td>
                                <td  class="text-center" class="text-right">
            ...
            <div class="fill-page-con" ng-show="listOrFill == 'fillPage'">
                 <div data-ng-include="'${ctx}/tpl/datang/reportPage/weekReport/weekReportChangePage.jsp'"></div>
            </div>
        </div>
    </div>
</div>
...
app.controller('dtWeekReportListCtrl', function($scope,$rootScope,$http, $state, $stateParams,$interval) {
    ...
    $scope.showFillPage = function(item){
        $scope.listOrFill = "fillPage";
        $scope.$broadcast("fillItem",[item ,"week"]);
    }
	...
	$scope.deleteBatch = function(){
        ...
        if (conti) {
            ...
            $http({
                method : "POST",
                url : "${ctx}/rpwSummary/deleteBatch.htm",
                params : {
                    'ids' :checkedIds
                }
            }).success(function(result) {
