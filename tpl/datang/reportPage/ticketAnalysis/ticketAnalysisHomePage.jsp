...
<div ng-controller="dtTicketAnalysisHomePageCtrl">
	...
	<div class="page-padding word-black">
		...
		<div class="clearfix">
					...
					<table id="result_table" class="table table-striped b-t b-light">
						...
						<tbody class="font12">
							<tr ng-repeat="vo in data">
								...
								<td class="text-center" ng-bind="vo.stationName "></td>
			...
			<div class="fill-page-con" ng-show="listOrFill == 'fillPage'">
				<div data-ng-include="'${ctx}/tpl/datang/reportPage/ticketAnalysis/ticketAnalysisFillReportModel.jsp'"></div> 
			</div>
		</div>
	</div>
</div>
...
app.controller('dtTicketAnalysisHomePageCtrl', function($scope,$rootScope,$http, $state, $stateParams,$interval) {
