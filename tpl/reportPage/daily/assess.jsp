<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<!-- 综合评估 -->
<div class="col-sm-12 wrapper first-right " ng-controller="stationEstimateDataForDay" >
...
<script>
app.controller('stationEstimateDataForDay',function($scope, $http, $state, $stateParams) {
		...
		$scope.getStationData=function(){
			$http.get("${ctx}/Report/getStationEstimateDataForDay2.htm",{
				params : {
					stid:$scope.stid,
	...
	function getZhpg(selfData,cityData,areaData){
		...
		option = {
			    ...
			    tooltip : {
			        trigger: 'axis',
			        //formatter: '{d1}<br/>{b0}:{c0}<br/>{b1}:{c1}<br/>{b2}:{c2}<br/>'
