...
<div class="bg-light lter b-b col-sm-12" id="head-title" style="padding:15px 0px" ng-controller="statisticalDataCtrl">
	<div class="">
		...
		<div class="col-sm-6 text-right hidden-xs pull-right"
			...
			<div class="inline m-r-md  text-center">
				...
				<div>
					<span class="text-base black-3">电站数量</span>
				</div>
			</div>
			<div class="inline m-r-md  text-center">
				<span class="m-b-xs m-n black-1 h3"
				...
				<div>
					<span class="text-base black-3">总装机量</span>
				</div>
			</div>
			<div class="inline m-r-md  text-center">
				...
				<div>
					<span class="text-base black-3">累计发电量</span>
				</div>
			</div>
			<div class="inline m-r-md  text-center">
				<span class="m-b-xs m-n black-1 h3" ng-bind="statDayData.co2[0]|dataNullFilter"></span>
				<span class="text-base black-1" ng-bind="statDayData.co2[1]|dataNullFilter"></span>
				<div>
					<span class="text-base black-3">二氧化碳减排</span>
				</div>
			</div>
...
var lot;
var lat;
app.controller('statisticalDataCtrl',function($scope, $http, $state, $stateParams) {
