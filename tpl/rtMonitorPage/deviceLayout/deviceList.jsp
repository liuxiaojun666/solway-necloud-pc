...
<div ng-controller="DeviceLayoutCtrl" >
	...
	<div ng-include="'${ctx}/tpl/systemPage/basemessage/modal/taskList_historyData4.jsp'"></div> -->
</div>
		...
		$scope.showInformation = function(id,serialnumber,pstationid) {
			$http({
				...
				if(result){
					...
					msg.deviceId = result.id;
					msg.pstationid = pstationid;
					$scope.showHistoryData_byRTMDeviceLogId(pstationid,result.id,serialnumber,'2',result.hasJB);
