...
<style>
	...
	.line-right3{color:#2687fe;}
	.right-line p:nth-child(2) {font-size: 30px;}
	.right-line p:nth-child(3){color:white;}
	.left-line2 .day-power {padding: 10px 3px 0px 6px;}
	.left-line2 .month-power {padding: 10px 3px 0px 6px;}
	.left-line3 .year-power {padding: 10px 3px 0px 6px;}
	.left-line3 .total-power {padding: 10px 3px 0px 6px;}
	.footer-left { padding: 0 12%;}
	.footer-right {padding: 0 7%;}
	.day-power >p:first-child,.day-power >p:nth-child(2) {color: #ffc740;}
	.year-power >p:first-child,.year-power >p:nth-child(2) {color: #fe6d26;}
	.total-power >p:first-child,.total-power >p:nth-child(2) {color: #fe26e2;}
</style>
<div ng-controller="mapMonitorCtrl" class="earth-bg">
	<div class="clearfix no-padder" style="height:100%;">
            ...
            <div class="width-right con-right pull-right">
            	<div class="clearfix">
                    <div class="right-line line-right2 pull-right">
                        <p><img src="theme/images/common/power-icon.png" style="margin-right:4px;width:20px;"><span>实时功率</span></p>
                ...
                <div class="clearfix">
                    <div class="right-line line-right3 pull-right">
                        <p><img src="theme/images/powerMeter/work-num.png" style="vertical-align: text-top;margin-right:4px;width:20px;"><span>工厂数量</span></p>
                        <p ng-bind="MonitorData.powerStationNum|dataNullFilter"><span></span></p>
                        <p >变压器总容量<span ng-bind="MonitorData.installedCapacity[0]|dataNullFilter"></span><span ng-bind="MonitorData.installedCapacity[1]|dataNullFilter"></span></p>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="map-footer">
			<div class="col-sm-8 footer-left">
				...
				<span class="state-con" style="color:rgb(32,208,58);"><i class="green"></i><span class="state-name">正常</span><span id="normalStNum"></span></span>
				<span class="state-con" style="color:rgb(255,74,36);"><i class="red"></i><span class="state-name">故障</span><span id="faultStNum"></span></span>
				<span class="state-con" style="color:rgb(245,255,0);"><i class="yellow"></i><span class="state-name">报警</span><span id="alarmStNum"></span></span>
			</div>
			<div class="col-sm-4 footer-right clearfix radiusMenu">
...
$(function(){
	...
	$(".con-left").css("marginTop",(wHeight-335)/2);
	$(".con-right").css("marginTop",(wHeight-335)/2);
});
...
var timeTicket;
var timer2;
app.controller('mapMonitorCtrl', function($scope,$rootScope,$http, $state, $stateParams) {
		...
		$http.get("${ctx}/Login/getLoginUser.htm", {
			...
			$http.get("${ctx}/Company/baseInfo.htm", {
				...
				if(result && result.data){
				    ...
				    while (i--) {
				        if ((result.data.proName+"").indexOf(mapType[i]) >= 0) { 
				        	mt = mapType[i];
				            break;  
				        }  
				    }  
