...
<script src="${ctx}/theme/js/controllers/file-upload.js" type="text/javascript"></script>
	...
	app.controller('UpdateUserInfoCtrl', ['$scope', 'toaster','$http', function($scope, toaster,$http) {
	    updateUserInfo = $scope.saveFormForUserMod = function(){
	    	$http({
				method : "POST",
				url : "${ctx}/AdminUser/updateDataSelective.htm",
...
<div class="row">
    <div class="col-sm-12">
      ...
      <div class="panel-body">
          <form class="bs-example form-horizontal ng-pristine ng-valid" action="${ctx}/AdminUser/updateDataSelective.htm" method="post" id="editFormForUserMod" name="editFormForUserMod">
