...
<script src="${ctx}/tpl/statisticAnalysisPage/js/controllers/staYear.js"></script>
<div class="col-sm-12 norm" ng-controller="staYearCtrl" >
	...
	<div class="col-sm-4 no-padder ">
		<div class="col-sm-12 no-padder m-b-1">
			...
			<div class="col-sm-6 wrapper padding-media text-center norm-module-year  hvr-solway">
	...
	<div class="col-sm-8 p-l-sm" ng-click="showYearElectric()">
	<div class="norm-black-bg">
		<span class="text-1-4x col-sm-12 no-padder m-t-xs m-l-sm">年发电量分析</span>
		<div class="col-sm-12 no-padder">
			<div class="col-sm-12 text-center m-t-xs"id="loadFlags">
			 </div>
			<div id="kwhTotalYearReport" style="height:180px;"></div>
		</div>
