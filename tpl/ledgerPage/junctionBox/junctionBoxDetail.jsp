...
<div ng-controller="JunctionBoxMonitorCtrl">
	...
	<ul class="nav navbar-nav hidden-sm col-sm-12" style="margin-top:-40px;">
		...
		<div class="wrapper-sm no-border-xs">
				...
				<tab ng-click="onSelectPageBjunction(1)"> 
				<tab-heading> 
				...
				<tab ng-controller="junctionpageHistory" ng-click="changeViewNotSearch()"> 
					<tab-heading class="wrapper-sm">
						<span id="historyInfojb" class="white-1 a-cur-poi">历史信息</span>
		         	...
		         	<button class=" btn btn-sm btn-info" ng-click="exportData();" type="button">导出</button>
		      		...
		      		<div class="col-sm-6 pull-right"><%@ include file="/common/pager.jsp"%></div>
				 		...
				 		<div class="col-sm-12 no-padder" id="loadingDiv"></div>
							<div class="col-sm-12 no-padder junWidth"  
							    ng-grid="junctionBoxGridOptions" id="junction_box_result_table" style="height: 350px;" >
							</div>
						</div>
						</paging>
				</tab>
				
				<tab ng-controller="faultAlarmJB" ng-click="changeViewNotSearchFault()"> 
					<tab-heading class="wrapper-sm">
					...
					<tab ng-controller="repairtJB" ng-click="onSelectPage(1)"> 
						<tab-heading class="wrapper-sm">
					...
					<tab ng-controller="experimentJB" ng-click="onSelectPage(1)"> 
						<tab-heading class="wrapper-sm">
	        	  ...
	        	  <tbody>
					...
					<tab ng-controller="replacedJB" ng-click="onSelectPage(1)"> 
						<tab-heading class="wrapper-sm">
