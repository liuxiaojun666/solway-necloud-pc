...
<script type="text/javascript">
	...
	function deleteBatch() {
		...
		if (conti) {
			var options = {
				type : "post",
				dataType : "json",
				url : "${ctx}/Product/deleteBatch.htm?"
	...
	app.controller('ProductCtrl', function($scope, $http, $state) {
		...
		$scope.onSelectPage = function(page) {
			...
			$http({
				method : "POST",
				url : "${ctx}/Product/productList.htm",
				params : {
					'pageIndex' : page - 1,
 ...
 <!-- 弹出层界面 -->     
<div id="productEdit" data-ng-include="'${ctx}/tpl/ledgerPage/product/addProduct.jsp'"></div>

<div ng-controller="ProductCtrl">
	<div class="wrapper-md bg-light b-b">
		<span class="font-h3 blue-1 m-n text-black">产品管理</span>
	</div>
	...
	<tbody >
			<tr ng-repeat="vo in data ">
				...
				<td  ng-bind="vo.productcode"></td>
				<td ng-bind="vo.productname"></td>
				<td ng-bind="vo.specification"></td>
				<td ng-bind="vo.manufname"></td>
				<td ng-bind="vo.perfrating"></td>
				<td ng-bind="vo.mainparameter"></td>
				<td>
