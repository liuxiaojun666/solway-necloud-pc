...
<script type="text/javascript">
	...
	function deleteBatch() {
		...
		if (conti) {
			var options = {
				type : "post",
				dataType : "json",
				url : "${ctx}/PFaultCode/deleteBatch.htm?"
	...
	app.controller('PFaultCodeCtrl', function($scope, $http, $state) {
		$scope.addFaultCode = function(cid) {
			$state.go("app.addFaultCode", {
				id : cid
			});
		}
		...
		$scope.onSelectPage = function(page) {
			...
			$http({
				method : "POST",
				url : "${ctx}/PFaultCode/faultCodeList.htm",
				params : {
					'pageIndex' : page - 1,
					'pageSize' : $scope.pageSizeSelect,
					keyWords:$scope.keyWords,
					faultdesc : $scope.pmName,
					faultcode : $scope.pmDictCode,
				}
 ...
 <!-- 弹出层界面 -->     
<div id="faultCodeEdit" data-ng-include="'${ctx}/tpl/ledgerPage/faultCode/addFaultCode.jsp'"></div>
<div  ng-controller="PFaultCodeCtrl">
	<div class="wrapper-md bg-light b-b">
		<span class="font-h3 blue-1 m-n text-black">状态码管理</span>
	</div>
	<div class="wrapper-md ng-scope">
       ...
       <div class="col-sm-4 m-b-xs w-sm p-r-sm">    
          <button  class="btn btn-sm btn-info m-r-xs"  ng-click="addFaultCode();"> 新增</button>
      ...
      <div class="col-sm-3 no-padder">
        ...
        <div class="input-group p-r-sm">
          ...
          <span class="input-group-btn">
 			<button id="searchBtn" class="btn btn-sm btn-info"
						ng-click="onSelectPage(1);" type="button">查询</button>          </span>
        </div>
        </div>
       ...
       <div class="input-group">
          <span class="input-group-btn">
            <button class="btn btn-sm btn-default" type="button">状态码</button>
          </span>
       ...
       <div class="input-group">
          <span class="input-group-btn">
            <button class="btn btn-sm btn-default" type="button">状态描述</button>
          </span>
    ...
    <table id="result_table" class="table table-striped b-t b-light">
			...
			<tbody role="alert" aria-live="polite" aria-relevant="all">
				<tr ng-repeat="vo in data ">
					...
					<td ng-bind="vo.productname+'-'+vo.productSpecification"></td>
					<td ng-bind="vo.faultcodeindex"></td>
					<td ng-bind="vo.faultcode"></td>
					<td ng-bind="vo.faultdesc"></td>
					<td>
						<a class="text-info">
         					 <i class="icon-note" ng-click="addFaultCode({{vo.id}});" ></i></a>
