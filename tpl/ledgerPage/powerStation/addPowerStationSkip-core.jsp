...
<script type="text/javascript">
			...
			submitHandler : function(form) {
				var options = {
					...
					success : function(json) {
						...
						if(""!=$('#url').val()){
							if(json.id!=null){
								$('#last_unfinish_bpowerstation_id').val(json.id);
							}
	...
	app.controller('StationCtrl', ['$http', '$location', '$rootScope', '$scope', '$state', '$stateParams', function($http, $location, $rootScope, $scope, $state, $stateParams){
		...
		getSelected = $scope.getA = function(){
...
<div ng-controller="StationCtrl">
	...
	<div class="wrapper-md ">
		<span class="font-h3 m-n font-thin">电站信息管理</span>  
	</div>
...
<!--             </div> -->
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-3">
                 <input type="text" id="stationtel" maxlength="17" name="stationtel" placeholder="区号-电话-分机   或  手机号" class="form-control formData">
             </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-3">
                <input type="text" id="stationzip" name="stationzip" maxlength="6" class="form-control formData">
              </div>
             </div>
             <div class="form-group">
             ...
             <div class="form-group">
              <label class="col-lg-2 control-label">详细地址</label>
                <div class="col-lg-8">
             	 <input type="text" id="address" name="address" maxlength="30" class="form-control formData">
             	</div>
             </div>
            <div class="form-group">
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-7 imgfile" style="width:510px">
                	<div class="fileimgsize">
	          			<img id="billImg0" class="fileImg0 fileimgsize" name = "billImg0" src="http://placehold.it/150x95">
	          			<input type="file" name="picture0" id ="picture0" class="file form-control formData" onchange="getImg(this,'fileImg0')"/>
          			</div>
          			<div class="fileimgsize">
	          			<img id="billImg1" class="fileImg1 fileimgsize" name = "billImg1" src="http://placehold.it/150x95">
	          			<input type="file"  name="picture1" id ="picture1" class="file form-control formData" onchange="getImg(this,'fileImg1')"/>
          			</div>
          			<div class="fileimgsize">
	          			<img id="billImg2" class="fileImg2 fileimgsize"  name = "billImg2" src="http://placehold.it/150x95">
              ...
              <div class="form-group">
                <label  class="col-lg-2 control-label">其他介绍</label>
                 <div  class="col-lg-8">
               		 <textarea rows="2" maxlength="500" name ="descp" id ="descp" class="form-control formData"></textarea>
                </div>
             </div>
          </form>
		<!-- form 结束 -->
