...
// 			        }
		...
		app.controller('addCompanyDepartmentCtrl', ['$http', '$location', '$rootScope', '$scope', '$state', '$stateParams', function($http, $location, $rootScope, $scope, $state, $stateParams){
			...
			$scope.backCompany = function(){
				$state.go('app.companyDepartment');
			  }
		}]);
	});
...
<div ng-controller="addCompanyDepartmentCtrl">
<div ng-controller="RegionCtrl">
	<div class="wrapper-md bg-light b-b">
		<span class="font-h3 blue-1 m-n text-black">组织机构管理</span>
	</div>
		...
		<form class="bs-example form-horizontal ng-pristine ng-valid" action="${ctx}/Company/update.htm" method="post" id="editForm" name="editForm">
          <input type="hidden" name="comId" value="{{$stateParams.cmId}}" id="comId" class="formData"/>
            <div class="form-group">
              <label class="col-lg-2 control-label"><i class="fa fa-asterisk text-required"/>机构名称</label>
              <div class="col-lg-8">
