...
<script type="text/javascript">
   ...
   app.controller('CompanyCtrl', function ($scope, $http,$state) {
	   $scope.createCompany = function(comId,comName){
			  $state.go("app.addCompany",{cmId:comId});
		}
...
<div ng-controller="CompanyCtrl">
	...
	<span class="font-h3 blue-1 m-n text-black">企业信息管理
	</span>
	</div>
...
<table id="result_table" class="table table-striped b-t b-light" width="90%">
	<thead>
		<tr>
			<!-- <th style="width: 4%">
			...
			<th class="t_center" width="10%">机构代码</th>
			<th class="t_center" width="20%">机构名称</th>
			<th class="t_center" width="10%">业主</th>
			<th class="t_center" width="10%">设备商</th>
			<th class="t_center" width="10%">EPC</th>
			<th class="t_center" width="10%">运维服务商</th>
			<th class="t_center" width="10%">操作</th>
		</tr>
	</thead>
	<tbody>
	<tr  ng-repeat="vo in data ">
		...
		<i></i></label> -->
			...
			<td class="t_center" ng-bind="vo.comCode"></td>
			<td class="t_left" ng-bind="vo.comName"></td>
			<td class="t_center" ng-bind="vo.isowner"></td>
			<td class="t_center" ng-bind="vo.ismanu"></td>
			<td class="t_center" ng-bind="vo.isepc"></td>
			<td class="t_center" ng-bind="vo.isservice"></td>
		<td class="t_center">
			<a class="text-info" href="#/app/companyDepartmentInfo"><i class="icon-note" data-commment-ng-click="createCompany({{ vo.comId}});" ></i></a>
