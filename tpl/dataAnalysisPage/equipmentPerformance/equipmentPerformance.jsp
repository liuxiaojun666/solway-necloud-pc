...
.modal-open {
 ...
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="equipmentPerformanceCtrl">
	...
	<div ng-include="'${ctx}/tpl/dataAnalysisPage/equipmentPerformance/modelContainer.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('equipmentPerformanceCtrl',function($scope, $http, $state, $stateParams) {
	$scope.showDay = false;
