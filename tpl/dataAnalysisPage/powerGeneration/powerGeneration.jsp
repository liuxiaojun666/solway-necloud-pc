...
<link rel="stylesheet" href="${ctx}/theme/css/dataAnalysisPage/powerGeneration.css">
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="powerGenerationCtrl">
	...
	<div ng-include="'${ctx}/tpl/dataAnalysisPage/powerGeneration/modelContainer.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('powerGenerationCtrl',function($scope, $http, $state, $stateParams) {
