			...
			<tbody >
				<tr ng-repeat="kwh in kwhList">
					<td class="text-center">
						 <span ng-bind="kwh.xaxisTime|date:'yyyy-MM'"></span>
					</td>
					<td class="text-center">
...
app.controller('yearChartCtrl',function($scope, $http, $state, $stateParams) {
	...
	$scope.$on('broadChangeDateToChildYear', function(event, data) {
		if(data){
			$scope.dtime =data[0];
		}
		$scope.getStationId();
	...
	$scope.monthData = function(){
		$http.get("./MobileHmDeviceMonitor/getYearChartGeneratingPower.htm",{
			params : {
