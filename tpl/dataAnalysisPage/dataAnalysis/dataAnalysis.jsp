...
.modal-open {
 ...
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="dataAnalysisCtrl">
	...
	<div ng-include="'${ctx}/tpl/dataAnalysisPage/dataAnalysis/assetDataModel.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('dataAnalysisCtrl',function($scope, $http, $state, $stateParams) {
