...
.modal-open {
 ...
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="troubleCtrl">
	...
	<div ng-include="'${ctx}/tpl/dataAnalysisPage/trouble/modelContainer.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('troubleCtrl',function($scope, $http, $state, $stateParams) {
	$scope.showDay = false;
