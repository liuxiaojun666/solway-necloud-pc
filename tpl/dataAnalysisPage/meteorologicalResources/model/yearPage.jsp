<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="mete-con" ng-controller="yearPageCtrl">
	...
	<div class="clearfix" style="background:white;">
		<span class="font-h4 black-1" style="margin-left: 20px;">辐射总量</span>
...
<script>
app.controller('yearPageCtrl',function($scope, $http, $state, $stateParams) {
	...
	function broadcastBarChartUp(data){
		if(data.echarts_xaxisTime){
			var arr = [];
			for(var i = 0;i<data.echarts_xaxisTime.length;i++){
				arr.push(data.echarts_xaxisTime[i].split("-")[1])
			}
			data.echarts_xaxisTime = arr;
		}
	...
	$scope.monthBarUpData = function(){
		$http({
			method : "POST",
			url : "./MobileHmDeviceMonitor/getYearStationPv.htm",
			params : {
