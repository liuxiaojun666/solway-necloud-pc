<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet" href="${ctx}/theme/css/dataAnalysisPage/meteorologicalResources.css">
<style>
.modal-open {
    overflow-y: auto;
}
</style>
 <div class="hbox hbox-auto-xs hbox-auto-sm"  ng-controller="meteResourcesCtrl">
	...
	<div ng-include="'${ctx}/tpl/dataAnalysisPage/meteorologicalResources/modelContainer.jsp'"></div>
</div>
<div data-ng-include="'${ctx}/tpl/blocks/switchPower.jsp'"></div> 
<script>
app.controller('meteResourcesCtrl',function($scope, $http, $state, $stateParams) {
