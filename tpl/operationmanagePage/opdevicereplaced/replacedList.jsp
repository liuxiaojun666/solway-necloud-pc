...
<script type="text/javascript">
	...
	function deleteBatch() {
		...
		if (conti) {
			var options = {
				type : "post",
				dataType : "json",
				url : "${ctx}/Replaced/deleteBatch.htm?"
	...
	app.controller('InverterCtrl', function($scope, $http, $state) {
		$scope.createInverter = function(id, name) {
			$state.go("app.addreplaced", {
				InId : id
			});
		}
		$scope.showInformation = function(id) {
			$state.go("app.replacedDetail", {
				InId : id
			});
		}
...
<div ng-controller="InverterCtrl">
	<div class="wrapper-md bg-light b-b">
	 	<span class="font-h3 blue-1 m-n text-black">设备技术改造</span>
	</div>
...
<!-- 			<td ng-bind="vo.deviceid"></td> -->
			...
			<td ng-bind="vo.replacedfact"></td>
			<td ng-bind="vo.operator"></td>
			<td ng-bind="vo.replaceddate |date:'yyyy-MM-dd'"></td>
			<td ng-bind="vo.replacedcontent"></td>
			<td ng-bind="vo.replacedresult"></td>
			<td>
