	...
	function deleteBatch() {
		...
		if (conti) {
			var options = {
				type : "post",
				dataType : "json",
				url : "${ctx}/Repair/deleteBatch.htm?"
...
<!-- 			<td ng-bind="vo.deviceid"></td> -->
			...
			<td ng-bind="vo.repairresult"></td>
			<td ng-bind="vo.operator"></td>
			<td ng-bind="vo.repairdate |date:'yyyy-MM-dd'"></td>
			<td ng-bind="vo.repaircontent"></td>
			<td>
