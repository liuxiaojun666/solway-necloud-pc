...
app.directive('contentLeft4', ['myAjaxData', function (myAjaxData) {
                                ...
                                function _callee3$(_context3) {
                                    while (1) {
                                        switch (_context3.prev = _context3.next) {
                                            ...
                                            case 3:
                                                $scope.deviceTypeVal = '3';
                                                $scope.deviceName = '';
                                                $scope.getDeviceName(2);
                                                $scope.$apply();
...
ajaxData({
    ...
    yName: '温度(℃)',
    lineName: ['设备温度', '平均温度']
})('boxChangeTemperatureAnomalyCtrl', ['$scope', 'myAjaxData'], function ($scope, myAjaxData) {
    _newArrowCheck(void 0, void 0);
}.bind(void 0));