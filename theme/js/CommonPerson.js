...
CommonPerson.Base.LoadingPic = {
    operation: {
        ...
        loadingImgUrl: "./theme/images/solway/icon/loading.gif",  //默认load图地址
    ...
    PartShow: function (parentContainerID, url, msg) {
        ...
        var htmlText = ' <div id="' + parentContainerID + '_loadingImg" class="loadingPage_bg"><div style=" margin: 0px auto;display: block; font-weight: bold; font-size: 12px; color: #595959; left: 50%; line-height: 27px; padding: 10px 10px 10px 50px; width: 120px; z-index: 111; background: url(./theme/images/solway/icon/loading.gif) no-repeat scroll 12px center transparent;background-size: 20px;">' + msg + '</div></div>'
